...
| File | Description |
|---|---|
| `Beta_Windows_Update_Common_Error_Detections.ps1` | Main diagnostic script |
...
.\Beta_Windows_Update_Common_Error_Detections.ps1

# Scan the last 30 days
.\Beta_Windows_Update_Common_Error_Detections.ps1 -StartDays 30
```
...
az vm run-command invoke \
  ...
  --scripts @Beta_Windows_Update_Common_Error_Detections.ps1
```
...
Invoke-AzVMRunCommand `
  ...
  -ScriptPath ".\Beta_Windows_Update_Common_Error_Detections.ps1"
```
