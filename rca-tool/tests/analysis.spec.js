...
test.describe('SAP HANA Cluster Analyzer', () => {
  ...
  test.beforeEach(async ({ page }, testInfo) => {
    ...
    // Local: /web/dist/
    // Deployed: './' to stay relative to baseURL (which includes /azure-support-scripts/)
    const path = testInfo.project.name === 'deployed' ? './' : '/web/dist/';
  ...
  */
  ...
  // =====================================================================
  // Firewall Rules Detection Tests
  // =====================================================================
...
// ===== NETWORK INTERFACES =====
test.describe('Network Interfaces Detection', () => {
  test.beforeEach(async ({ page }, testInfo) => {
...
// ========================================================================
// VMCORE / KERNEL CRASH DUMP DETECTION
// ========================================================================
test.describe('Kernel Crash Dump Detection', () => {
  test.beforeEach(async ({ page }, testInfo) => {
    const navPath = testInfo.project.name === 'deployed' ? './' : '/web/dist/';
    await page.goto(navPath);
    await expect(page.locator('h1')).toContainText('RCA Tool');
